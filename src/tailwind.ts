...
const TW_PREFIXES =
  '(?:bg|text|border|ring|shadow|accent|outline|decoration|fill|stroke|from|via|to|divide|placeholder)'
const TW_COLORS =
  '(?:slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)'
const TW_SHADES = '(?:50|100|200|300|400|500|600|700|800|900|950)'

const TAILWIND_PATTERN = new RegExp(`^${TW_PREFIXES}-(${TW_COLORS})-(${TW_SHADES})$`)

const TAILWIND_SIMPLE_PATTERN = new RegExp(`^${TW_PREFIXES}-(black|white)$`)
