/** Default Tailwind CSS v3 color palette */
...
const TW_PREFIXES = '(?:bg|text|border|ring|shadow|accent|outline|decoration|fill|stroke|from|via|to|divide|placeholder)'
...
const TAILWIND_SIMPLE_PATTERN = new RegExp(
 ...
 */
export function extractTailwindColor(text: string): string | null {
